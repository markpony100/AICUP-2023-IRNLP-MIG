...
if __name__ == "__main__":
    #parameters
    ori_data_path = "../preprocess/all_test.jsonl"
    test_data_folder = "../pert_large/sent/0522_base_clu_folds_PN13/all_test/"
    save_test_path = "../pert_large/sent/0522_base_clu_folds_PN13/ttest_ens5.jsonl"
    TOPK = 5
    #load data
